...
export function Header() {
  return (
    <header className="flex flex-col">
      <div className="flex p-[2rem] md:hidden">
        <Sheet>
        ...
        <div className="flex w-full justify-center">
          <Image src={monamigabilogo} alt="mon-ami-gabi-logo.png" width={180} />
        </div>
      </div>
      <div className="hidden w-full items-center justify-between py-[2rem] pb-0 md:flex">
        <div className="flex w-1/7 flex-col">
          <ul className="flex h-full justify-center gap-1">
            <li className="mb-1">
              <Link
                href="https://x.com/MonAmiGabiChi"
                aria-label="Visit our Twitter profile"
          ...
          <div className="relative mt-1 w-full">
            ...
            <div className="bg-border absolute top-1/2 right-0 h-2 w-2 -translate-y-1/2 rounded-full"></div>
          </div>
        </div>

        <div className="flex grow justify-center">
          <Image src={monamigabilogo} alt="mon-ami-gabi-logo.png" width={300} />
        </div>
        ...
        <div className="flex w-1/7 flex-col">
          ...
          <a href="#" className="text-center text-sm font-light">
            CHANGE LOCATION
          </a>
          <div className="relative mt-1 w-full">
            <div className="bg-border h-px w-full"></div>
            <div className="bg-border absolute top-1/2 left-0 h-2 w-2 -translate-y-1/2 rounded-full"></div>
          </div>
        </div>
      </div>
