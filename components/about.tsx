...
export function About() {
  return (
    <div className="mb-10 flex h-fit w-full flex-col items-start justify-center p-[2rem] md:flex-row">
      ...
      <div className="flex w-full flex-col md:w-1/2 md:justify-center md:p-10 lg:max-w-[480px] lg:p-12 xl:p-15 2xl:self-center">
        ...
        <div>
          <p className="inline font-light">
            ...
            something to satisfy all tastes. For those looking to indulge in
            a{" "}
          </p>
          <p className="inline text-[#751a2b] italic">unique dish</p>,
          <p className="inline font-light">
            {" "}
          ...
          <p className="inline text-[#751a2b] italic">
