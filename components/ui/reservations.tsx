...
export function Reservation() {
	...
	return (
		<div className="flex w-full flex-col-reverse   md:flex-row">
			<div className="bg-card font-heading flex w-full content-center items-center justify-center font-bold md:w-1/2">
				<div className="flex w-full flex-col p-[2rem] text-center text-3xl md:w-fit">
							...
							children={(field) => (
								<>
									...
									<select
										...
										className="font-body bg-background w-full border p-2 text-center text-lg font-normal"
									>
										<option
											value=""
											disabled
									...
									<Popover>
										<PopoverTrigger asChild>
											<Button
												variant={"outline"}
												className={cn(
													"font-body bg-background w-full  justify-center text-center font-normal",
					...
					<form.Subscribe
						...
						children={([isValid, isDirty, isSubmitting]) => (
							<Button
								type="submit"
								className="bg-primary hover:bg-primary/90 mt-3 w-full py-3 text-base font-normal uppercase text-white"
