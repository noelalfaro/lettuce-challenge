...
export function Location() {
	return (
		<div className="bg-primary flex w-full flex-col md:flex-row">
			<div className="relative hidden w-full overflow-hidden md:flex md:grow">
				<Image
					src={Charcuterie}
					alt="charcuterie.png"
					width={0}
			...
			<div className="text-primary-foreground flex w-full items-center justify-center p-[2rem] md:grow">
